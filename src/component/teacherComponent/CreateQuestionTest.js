                    ...
                    <div className="col-xs-8 col-sm-8 col-md-8 col-lg-8 mt-30 khung">
                        ...
                        <form method="POST" role="form" action="add" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input onChange={this.handleChange} type="text" class="form-control" name="text" placeholder="Nội dung câu hỏi"></input>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group">
                                ...
                                <input onChange={this.handleChange} type="text" class="form-control" name="optionA" placeholder="Đáp án A"></input>
                            </div>
                            <div class="form-group">
                                <label for="">Đáp án B</label>
                                <input onChange={this.handleChange} type="text" class="form-control" name="optionB" placeholder="Đáp án B"></input>
                            </div>
                            <div class="form-group">
                                <label for="">Đáp án C</label>
                                <input onChange={this.handleChange} type="text" class="form-control" name="optionC" placeholder="Đáp án C"></input>
                            </div>
                            <div class="form-group">
                                <label for="">Đáp án D</label>
                                <input onChange={this.handleChange} type="text" class="form-control" name="optionD" placeholder="Đáp án D"></input>
                            </div>
                            <div className="form-group">
                                <label htmlFor="">Điểm</label>
                                <input onChange={this.handleChange} type="text" className="form-control" name="point"
